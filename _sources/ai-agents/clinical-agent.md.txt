...
Med-SEAL V1 refers to [**`aagdeyogipramana/Med-SEAL-V1`**](https://huggingface.co/aagdeyogipramana/Med-SEAL-V1) — the fine-tuned **base model** that powers the clinical reasoning capabilities of the Med-SEAL platform.
...
| Agent | How it uses Med-SEAL-V1 |
|---|---|
| **A2** (Clinical Reasoning) | Calls Med-SEAL-V1 for drug interactions, lab interpretation, condition reasoning |
| **A5** (Insight Synthesis) | Calls Med-SEAL-V1 for pre-visit clinical brief generation |
| **A1** (Companion) | Indirectly — delegates complex questions to A2, which calls Med-SEAL-V1 |
...
|---|---|---|
| **Model** | SEA-LION v4-32B (AI Singapore) | [`aagdeyogipramana/Med-SEAL-V1`](https://huggingface.co/aagdeyogipramana/Med-SEAL-V1) (Qwen3-VL-8B fine-tuned) |
...
- {doc}`../technical-report-v1` — Full technical report on Med-SEAL-V1
